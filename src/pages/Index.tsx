  ...
  const sections = [
    {
      ...
      title: "Yang",
      italic: "terancam.",
      body: "Coral Triangle, 507 spesies karang, 872 ikan karang, dan penyu — ekosistem rapuh yang menghadapi 46.105 kg sampah per hari.",
      image: coralImg,
    },
    {
      to: "/culture",
      ...
      title: "Yang",
      italic: "menjaga.",
      body: "Suku Bajau, tradisi Mag'jamu, dan ekonomi konservasi yang melindungi laut sebagai aset utama.",
      image: bajauImg,
    },
    {
      to: "/stories",
      ...
      title: "Cerita yang",
      italic: "menetap.",
      body: "Suara, foto, dan kenangan dari mereka yang pernah menyentuh laut Derawan.",
      image: turtleImg,
    },
  ];
